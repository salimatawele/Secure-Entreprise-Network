...
* **DNS / Server Configuration** : Service DNS actif et enregistrement de type A configuré avec succès.
...
* **Security testing** : Sécurité de niveau 2 (Port Security, DHCP Snooping, DAI) et filtrage par ACL en place et actifs.ve.
...
* **Filtrage du trafic par Listes de Contrôle d'Accès (ACL)** : Sécurisation et restriction des flux non désirés. -> *Correction : modification et création des ACL pour n'autoriser que l'accès au trafic web HTTP et HTTPS.*
